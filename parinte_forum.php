...
$rezultat = $engine->db->query("select * from forum_subiecte where id_clasa=".$_SESSION['id_clasa']." order by denumire_subiect ASC");
...
if($rezultat->rowCount()>=1)
{
    ...
    {
        echo '<tr> <td style="width:45px"> <img style="width:40px" src="img/folder.png"> </td> <td> <a href="parinte_forum_subiect.php?id_subiect='.$row['id_subiect'].'"> <h3>'.$row['denumire_subiect'].' </h3> </a> </td> 
        </tr>';
    }
    echo '</table>';
}
